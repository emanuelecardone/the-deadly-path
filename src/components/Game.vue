<template>
    ...
    <section class="game">
        <div class="w-100 d-flex justify-content-between align-items-center">
            <a @click="goBack('levels')" href="#" class="text-decoration-none fs-4">Choose level</a>
            <h2>{{levels[current.level].name}}</h2>
            <a @click="goBack('menu')" href="#" class="text-decoration-none fs-4">Main menù</a>
        </div>
...
export default {
    ...
    methods: {
        // Funzione back to levels o menù
